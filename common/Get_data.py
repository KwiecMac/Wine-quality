...
class GetData:
    ...
    def import_not_all_data(self, selected_columns: numpy.ndarray) -> numpy.ndarray:

        columns_names = self.import_names_of_columns()

        data = pd.read_csv(self.dataset_path, sep=';', names=columns_names, usecols=selected_columns)
        return data.values
